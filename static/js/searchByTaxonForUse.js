          ...
          function success(relations) {
            ...
            thtable = $('#results_taxon_use').DataTable(
              ...
              $('#spinner_taxon_use2').hide();
                ...
                $('#results_taxon_use').DataTable().rows().every(function() {
...
$('input.column_filter').on( 'keyup click', function () {
  filterColumnuse($(this).parents('td').attr('data-column'));
} );
...
function filterColumnScore(column){
    ...
    $('#results_taxon_use').DataTable().draw();
    checkURL();
}
